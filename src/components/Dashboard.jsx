...
const POLICY_INFO = {
  scp_baby_boost: {
    ...
    explanation: (
      <li>
        <strong>SCP Premium for under-ones</strong>: The Budget raises the
        Scottish Child Payment to £40 per week for children under one year old
        (£11.15/week extra in 2027-28). Both the total and standard rate are CPI
        uprated annually. Commences 2027-28, subject to parliamentary approval.
        <details className="policy-table-details" style={{ marginTop: "12px" }}>
          ...
          <table style={tableStyle}>
            ...
            <tbody>
              <tr>
                ...
                <td style={tdRightStyle}>£27.15</td>
                <td style={tdRightStyle}>—</td>
                <td style={tdRightStyle}>£27.15</td>
              </tr>
              <tr>
                <td style={tdStyle}>2026-27</td>
                <td style={tdRightStyle}>£28.20</td>
                <td style={tdRightStyle}>—</td>
                <td style={tdRightStyle}>£28.20</td>
              </tr>
              <tr>
                <td style={tdStyle}>2027-28</td>
                <td style={tdRightStyle}>£28.85</td>
                <td style={{ ...tdRightStyle, color: "#2e7d32" }}>+£11.15</td>
                <td style={{ ...tdRightStyle, color: "#2e7d32" }}>£40.00</td>
              </tr>
              <tr>
                <td style={tdStyle}>2028-29</td>
                <td style={tdRightStyle}>£29.45</td>
                <td style={{ ...tdRightStyle, color: "#2e7d32" }}>+£11.35</td>
                <td style={{ ...tdRightStyle, color: "#2e7d32" }}>£40.80</td>
              </tr>
              <tr>
                <td style={tdStyle}>2029-30</td>
                <td style={tdRightStyle}>£30.05</td>
                <td style={{ ...tdRightStyle, color: "#2e7d32" }}>+£11.60</td>
                <td style={{ ...tdRightStyle, color: "#2e7d32" }}>£41.65</td>
              </tr>
              <tr>
                <td style={{ ...tdStyle, borderBottom: "none" }}>2030-31</td>
                <td style={{ ...tdRightStyle, borderBottom: "none" }}>
                  £30.65
                </td>
                <td
                  style={{
          ...
          <p style={noteStyle}>
            Note: Under-one premium starts 2027-28. Both standard rate and
            premium uprated by CPI annually. Source:{" "}
            <a
              href="https://www.gov.scot/publications/scottish-budget-2026-2027/"
              target="_blank"
  ...
  income_tax_basic_uplift: {
    ...
    explanation: (
      <li>
        <strong>Basic rate threshold uplift (+7.4%)</strong>: The Budget raises
        the basic rate (20%) threshold from £15,398 to £16,538. This means
        taxpayers can earn £1,140 more before paying the 20% basic rate instead
        of the 19% starter rate.
        <details className="policy-table-details" style={{ marginTop: "12px" }}>
          ...
          <p style={noteStyle}>
            Note: Baseline shows CPI-only growth . Reform shows 7.4% uplift in
            2026-27, then CPI growth. Source:{" "}
            <a
  ...
  income_tax_intermediate_uplift: {
    ...
    description:
      "Intermediate rate threshold raised from £27,492 to £29,527 (+7.4%)",
    explanation: (
      <li>
        <strong>Intermediate rate threshold uplift (+7.4%)</strong>: The Budget
        raises the intermediate rate (21%) threshold from £27,492 to £29,527.
        This means taxpayers can earn £2,035 more before paying the 21%
        intermediate rate instead of the 20% basic rate.
        <details className="policy-table-details" style={{ marginTop: "12px" }}>
          <summary style={summaryStyle}>
  ...
  higher_rate_freeze: {
    ...
    explanation: (
      <li>
        <strong>Higher rate threshold freeze</strong>: The higher rate (42%)
        threshold remains frozen at £43,662 from 2025-26 through 2028-29, then
        resumes CPI uprating (£44,553 in 2029-30, £45,444 in 2030-31). Without
        the freeze, the threshold would reach ~£47k by 2030-31. The freeze
        raises revenue by bringing more taxpayers into the higher rate band.
        <details className="policy-table-details" style={{ marginTop: "12px" }}>
          <summary style={summaryStyle}>
          ...
          <p style={noteStyle}>
            Note: Baseline assumes CPI growth after 2026-27. Freeze confirmed
            until 2028-29; 2029-30 onwards assumes CPI uprating. Source:{" "}
            <a
              href="https://www.gov.scot/publications/scottish-budget-2026-2027/pages/3/"
              target="_blank"
              rel="noopener noreferrer"
            >
              Scottish Budget Chapter 2
            </a>{" "}
            |{" "}
            <a
  ...
  advanced_rate_freeze: {
    ...
    explanation: (
      <li>
        <strong>Advanced rate threshold freeze</strong>: The advanced rate (45%)
        threshold remains frozen at £75,000 from 2025-26 through 2028-29, then
        resumes CPI uprating (£76,530 in 2029-30, £78,061 in 2030-31). Without
        the freeze, the threshold would reach ~£81k by 2030-31. The freeze
        raises revenue from higher earners.
        <details className="policy-table-details" style={{ marginTop: "12px" }}>
          <summary style={summaryStyle}>
  ...
  top_rate_freeze: {
    ...
    explanation: (
      <li>
        <strong>Top rate threshold freeze</strong>: The top rate (48%) threshold
        remains frozen at £125,140 from 2025-26 through 2028-29, then resumes
        CPI uprating (£127,693 in 2029-30, £130,247 in 2030-31). Without the
        freeze, the threshold would reach ~£136k by 2030-31. The freeze raises
        revenue from the highest earners.
        <details className="policy-table-details" style={{ marginTop: "12px" }}>
          <summary style={summaryStyle}>
          ...
          <p style={noteStyle}>
            Note: Baseline assumes CPI growth after 2026-27. Freeze confirmed
            until 2028-29; 2029-30 onwards assumes CPI uprating. £125,140 aligns
            with UK Personal Allowance taper. Source:{" "}
            <a
              href="https://www.gov.scot/publications/scottish-budget-2026-2027/pages/3/"
              target="_blank"
              rel="noopener noreferrer"
...
export default function Dashboard({ selectedPolicies = [] }) {
  ...
  const decileYAxisDomain = useMemo(() => {
    ...
    AVAILABLE_YEARS.forEach((year) => {
      deciles.forEach((decile) => {
        ...
        maxAbsRelative = Math.max(
          maxAbsRelative,
          Math.abs(posRelative),
          Math.abs(negRelative),
        );
        maxAbsAbsolute = Math.max(
          maxAbsAbsolute,
          Math.abs(posAbsolute),
          Math.abs(negAbsolute),
        );
      });
    });
    ...
    const absInterval =
      maxAbsAbsolute <= 50 ? 10 : maxAbsAbsolute <= 100 ? 20 : 50;
    const roundedRelative =
      Math.ceil((maxAbsRelative * 1.1) / relInterval) * relInterval || 1;
    const roundedAbsolute =
      Math.ceil((maxAbsAbsolute * 1.1) / absInterval) * absInterval || 40;
  ...
  return (
    <div className="dashboard">
      ...
      <p className="chart-description">
        ...
        <a
          href="https://www.gov.scot/publications/scottish-budget-2026-2027/documents/"
          target="_blank"
          rel="noopener noreferrer"
        >
          announced
        </a>{" "}
        the Scottish Budget 2026–27 on 13 January 2026. This dashboard estimates
        how the budget affects household incomes, poverty rates, and different
        areas across Scotland. The government also announced a{" "}
        <a
          href="#mansion-tax"
          onClick={(e) => {
            e.preventDefault();
            ...
            if (mansionTaxSection) {
              ...
              mansionTaxSection.scrollIntoView({
                behavior: "smooth",
                block: "start",
              });
            }
      ...
      >
        <summary
          style={{ cursor: "pointer", color: "#2c6e49", fontWeight: "500" }}
        >
        ...
        <details className="methodology-details" style={{ marginTop: "12px" }}>
          ...
          <p>
            ...
            <a
              href="https://github.com/PolicyEngine/scottish-budget-2026-2027"
              target="_blank"
              rel="noopener noreferrer"
            >
              PolicyEngine microsimulation model
            </a>
            , which{" "}
            <a
            ...
            the Family Resources Survey to match Scottish demographics. See
            also:{" "}
            <a
            ...
            |{" "}
            <a
              href="https://policyengine.org/uk/research/uk-poverty-analysis"
              target="_blank"
              rel="noopener noreferrer"
            >
              poverty methodology
      ...
      <h2
        ...
        ref={(el) => (sectionRefs.current["income-tax-benefits"] = el)}
      ...
      <h3
        className="section-title"
        id="budgetary-impact"
        ref={(el) => (sectionRefs.current["budgetary-impact"] = el)}
        style={{
          fontSize: "1.4rem",
          fontWeight: 600,
          color: "#374151",
      ...
      <p className="chart-description">
        This section shows the estimated fiscal cost of the budget measures to
      ...
      <h3
        className="section-title"
        id="living-standards"
        ref={(el) => (sectionRefs.current["living-standards"] = el)}
        style={{
          fontSize: "1.4rem",
          fontWeight: 600,
          color: "#374151",
      ...
      <p className="chart-description">
        This section shows how household incomes in Scotland change as a result
        of the {policyInfo.name} policy.
      </p>
      ...
      <h3
        className="section-title"
        id="poverty"
        ref={(el) => (sectionRefs.current["poverty"] = el)}
        style={{
          fontSize: "1.4rem",
          fontWeight: 600,
          color: "#374151",
      ...
      <p className="chart-description">
        ...
        The UK uses four poverty measures: absolute vs relative poverty, each
        measured before or after housing costs. Absolute poverty uses a fixed
        threshold (60% of 2010-11 median income, adjusted for inflation), while
        relative poverty uses 60% of current median income.
      </p>
      ...
      <h3
        ...
        ref={(el) => (sectionRefs.current["local-authorities"] = el)}
        style={{
          fontSize: "1.4rem",
          fontWeight: 600,
          color: "#374151",
      ...
      <p className="chart-description">
        This section shows how the budget measures affect different local
        authorities across Scotland. Select a local authority to see the
        estimated impact on households in that area.
      </p>
      ...
      {/* Mansion Tax Section */}
      <details
        className="mansion-tax-section"
        id="mansion-tax"
        ref={(el) => (sectionRefs.current["mansion-tax"] = el)}
        style={{ marginTop: "32px" }}
      >
        <summary
          className="section-title"
        ...
        <p className="chart-description" style={{ marginTop: "12px" }}>
          ...
          <a
            href="https://www.gov.scot/publications/scottish-budget-2026-2027/pages/5/"
            target="_blank"
            rel="noopener noreferrer"
          >
            introduced
          </a>{" "}
          two new council tax bands for properties with a 2026 market value
          above £1 million, effective from April 2028. The Finance Secretary{" "}
          <a
            href="https://www.lbc.co.uk/article/wealthy-scots-in-snp-sights-as-budget-proposes-mansion-house-tax-and-a-tax-on-pr-5HjdQg9_2/"
            target="_blank"
            rel="noopener noreferrer"
          >
            estimated £16m
        ...
        >
          ...
          >
            ...
            >
              <a
                href="https://github.com/PolicyEngine/scottish-budget-2026-2027/tree/main/scotland-mansion-tax"
                target="_blank"
                rel="noopener noreferrer"
                style={{
                  color: "#0F766E",
